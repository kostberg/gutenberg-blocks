...
const allowedBlocks = [ 'core/image', 'ia/block-citat' ];
...
function applyExtraClass( extraProps, blockType, attributes ) {
	...
	if ( typeof visibleOnMobile !== 'undefined' && !visibleOnMobile && allowedBlocks.includes( blockType.name ) ) {
        extraProps.className += ' mobile-hidden';
...
const rearrangeBlockCategories = {
    'core/image': 'ia-blocks',
};

wp.hooks.addFilter('blocks.registerBlockType', 'ia', (settings, name) => {
